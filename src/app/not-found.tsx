            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto text-center mb-9">
                  <Image src={"images/404.svg"} alt={"404"} width={1020} height={1080}></Image>
                </div>
        ...
        <div className="absolute bottom-0 left-0 z-[-1] hidden sm:block">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#e0ad50" stopOpacity="0" />
                <stop offset="1" stopColor="#e0ad50" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#e0ad50" />
                <stop offset="1" stopColor="#e0ad50" stopOpacity="0" />
              </linearGradient>
              <linearGradient
